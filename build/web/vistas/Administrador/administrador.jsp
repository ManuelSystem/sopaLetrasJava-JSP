<%-- 
    ...
    Created on : 22/05/2020, 07:23:05 PM
    Author     : Manuel
--%>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    ...
                    <ul class="nav nav-sidebar">
                        ...
                        <li><a href="scoreGame.jsp"> <i class="fab fa-gripfire"></i> Records </a></li>
                    </ul>
                </div>
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Administrar Jugadores Registrados</h1>
                        ...
                        <div role="tabpanel" class="tab-pane active" id="home">
                            ...
                            <table id="example" class="table table-striped table-bordered table-responsive" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ArrayList<String> lista = faca.obtenerDatosJugadores();
                                    ...
                                    <tr>
                                        ...
                                        <td> <%=dato2[6]%> </td>
                                        <td> <%=dato2[7]%> </td>
                                        <td><input type="button" class="btn btn-success" name="btnModificar" value="Editar" onclick="location.href = 'editarDatosJugador.jsp?idPersona=<%=dato2[0]%>'"> </td>
                                        <td><input type="button" class="btn btn-danger" name="btnEliminar" value="Eliminar" onclick="location.href = '../../ControladorJugador?idPersona=<%=dato2[0]%>&&accion=eliminar'">
                                    </tr>
