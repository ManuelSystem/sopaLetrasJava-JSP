<%-- 
    Document   : jugador
    Created on : 22/05/2020, 10:18:57 PM
    Author     : Manuel
--%>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">¡Juega ahora y sé el mejor!</h1>
                    
                     <!-- Div de alerta de informción -->
                    <div class="alert alert-info alert-dismissible" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Información!</strong> Una vez des clic en vamos... iniciará el tiempo de partida, no pierdas tiempo y sé el mejor
                    </div>
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                            <br>
                            <br>
                            <div class="row contenedorForms" id="formulario">
                                <form action="../../ControladorJuego" method="post">
                                    <input type="text" name="jugador" value="<%=sesion[6]%>" style="visibility:hidden "/>

                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            <label for="" >Tiempo:</label>
                                            <label for="" >Minutos</label>
                                            <input type="text" class="form-control" id="minutes" name="minuto" value="00" readonly="">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="" >Segundos</label>
                                            <input type="text" class="form-control" id="seconds" name="segundo" value="00" readonly="">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="">Puntuación de Juego</label>
                                            <input type="text" class="form-control" id="score" name="puntuacion" value="00" readonly="">
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="">Nivel de Juego</label>
                                            <input type="text" class="form-control" name="nivel" value="1" readonly="">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2" id="detener">
                                            ...
                                            <Button type="submit" onclick="detenerTime();"  class="btn btn-danger"  name="accion" value="registrarNivel1">Siguiente Nivel</Button>
            ...
            <script>
                var words = ['AMARILLO', 'CAMA', 'MESA', 'OJO', 'ROJO', 'VERDE', 'PAPEL'];
